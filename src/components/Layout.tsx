      ...
      <div className="min-h-screen flex flex-col w-full bg-background">
        ...
        <header className="h-16 md:h-14 bg-sidebar border-b border-sidebar-border flex items-center px-4 sticky top-0 z-[60]">
          <div className="flex items-center gap-3">
            ...
            <SidebarTrigger className="text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground max-md:min-h-[44px] max-md:min-w-[44px] max-md:p-2" />
