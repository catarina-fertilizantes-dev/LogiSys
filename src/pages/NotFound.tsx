...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">import { useLocation } from "react-router-dom";
import { useEffect } from "react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Home, AlertTriangle } from "lucide-react";
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="pt-0 text-center space-y-6">
          <div className="flex justify-center">
            <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
          ...
          <div className="space-y-3">
            ...
            <CardTitle className="text-lg sm:text-xl">Página não encontrada</CardTitle>
